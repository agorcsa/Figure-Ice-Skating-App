...
public class Main4Activity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private void initScore() {
        ...
        // when we go back from Main6Activity we have those values set:
        // (alghtough right now there is no back from Main6Activity)
    ...
    public void startThirdActivity(View view) {
        Log.d("andre", "in activity 5. starting activity 3");
    ...
    public void startSixthActivity(View view) {
        Log.d("andre", "in activity 5. starting activity 6");
        Intent main6Activity = new Intent(this, Main6Activity.class);

        main6Activity.putExtra("com.example.android.startpageice.Steps1Score", mScore1Steps);
        main6Activity.putExtra("com.example.android.startpageice.Steps2Score", mScore2Steps);
        main6Activity.putExtra("com.example.android.startpageice.Jumps1Score", mScore1Jumps);
        main6Activity.putExtra("com.example.android.startpageice.Jumps2Score", mScore2Jumps);
        main6Activity.putExtra("com.example.android.startpageice.Spins1Score", mSkaterScores[0]);
        main6Activity.putExtra("com.example.android.startpageice.Spins2Score", mSkaterScores[1]);

        startActivity(main6Activity);
    }
